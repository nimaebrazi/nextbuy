...
public final class JsonPaths {
    ...
    public static ResultMatcher accessToken(String token) {
        return jsonPath(ApiJsonPaths.ACCESS_TOKEN).value(token);
    }

    public static ResultMatcher refreshToken(String token) {
        return jsonPath(ApiJsonPaths.REFRESH_TOKEN).value(token);
    }

    public static ResultMatcher profileId(Long id) {
        return jsonPath(ApiJsonPaths.PROFILE_ID).value(id);
    }

    public static ResultMatcher profileEmail(String email) {
        return jsonPath(ApiJsonPaths.PROFILE_EMAIL).value(email);
    }
